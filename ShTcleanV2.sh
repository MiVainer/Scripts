...
# после написания скрипта копируем его в дирректорию /usr/bin, назначаем права на исполнение командой chmod +x /usr/bin/ShTclean.sh
# вводим команду crnotab -e, вставляем следующую строку:
